...
from dotenv import load_dotenv #Su trabajo es leer el fichero .env y cargar las variables de entorno definidas en él en el entorno de ejecución de Python.
...
load_dotenv() #Basicamente abre el fichero .env y lee el contenido, cargando las variables de entorno definidas en él para que puedan ser accedidas a través de os.getenv().

MONGO_URI= os.getenv("MONGO_URI") #Aquí se utiliza os.getenv() para obtener el valor de la variable de entorno "MONGO_URI" que se ha definido en el archivo .env.
